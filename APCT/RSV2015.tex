...
can be used to index time: \textbf{chronological age ($A$), period ($P$), birth cohort ($C$), thanatological
...
measures \textbf{that generates a 3-dimensional space}
...
its one derived time measure. \textbf{For example, $A$ and $P$ form an informative dyad from which $C$ can be derived}
\item[A hexad identity] is \sout{the union of an informative triad and its three
derived time measures} \textbf{a unique combination of the six time measures}.
\end{description}
