...
can be derived, forming a triad identity. For instance, if we take the dyad AP,
C is the derived measure, and APC the corresponding triad identity. Uninformative dyads are pairs of time measures that do not have any
derived times measure, as for example L and P. In this section we aim to derive
mappings of each dyad to its temporal plane. We first discuss the choice between
...
\subsection{Mapping dyads to diagrams}
