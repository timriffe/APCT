...
age'' (A). The second index is death cohort (D), which groups all individuals (of different ages) dying in the same time period. Finally, lifespan (L) or age of death itself is an index by which data may be structured.
...
imagining the modern Gregorian calendar. We also describe the framework in terms of human lifespans, although it applies in a more general sense to any durations observed over time.
