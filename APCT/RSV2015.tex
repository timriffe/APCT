...
\begin{description}
\item[Time measures] are any of the six time indices discussed to describe
demographic time: chronological age (A), period (P), birth cohort (C), thanatological age (T), lifespan (L), and death cohort (D).
...
three different time measures, with the property that any of them can be derived
from the other two with no additional information. There are four triad
...
%FloatBarrier
Our model description is conceived in absolute, linear, Newtonian time. We
describe time in terms of years, the dominant time scale for human demography, although all relationships
are scalable to any time unit. We therefore speak of calendar time,
...
to exit, or any other terminal state. 
...
The concepts of thanatological age and death cohorts are likely less famialar to
...
Lexis diagram \citep{lexis1875einleitung}. The informative dyads AC(P) and
CP(A) also belong to the Lexis identity, but imply different less-common rotations and projections of the Lexis diagram. 
...
Under this representation, the three variants of each triad identity are
...
\begin{longtable}{m{0.13\textwidth}m{0.37\textwidth}m{0.14\textwidth}m{0.17\textwidth}}
  ...
  \includegraphics[scale=.5]{Figures/DiagramTable/AP_rt-crop.pdf}
  &
  \includegraphics[scale=.5]{Figures/DiagramTable/AP_iso-crop.pdf}
  \\
  %%%% ACp
  $$\begin{aligned}
    &AC(P) \\
  ...
  \includegraphics[scale=.5]{Figures/DiagramTable/AC_rt-crop.pdf} & 
  \includegraphics[scale=.5]{Figures/DiagramTable/AC_iso-crop.pdf}  \\
  %%%% CPa
  $$\begin{aligned}
    &CP(A) \\
    &A = P - C
  ...
  \includegraphics[scale=.5]{Figures/DiagramTable/CP_rt-crop.pdf} & 
  \includegraphics[scale=.5]{Figures/DiagramTable/CP_iso-crop.pdf}  \\
  \midrule
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \includegraphics[scale=.5]{Figures/DiagramTable/TP_rt-crop.pdf} &
  \includegraphics[scale=.5]{Figures/DiagramTable/TP_iso-crop.pdf}  \\
  %%%% PDt
  $$\begin{aligned}
    &PD(T) \\
    &T = D - P
  ...
  \includegraphics[scale=.5]{Figures/DiagramTable/PD_rt-crop.pdf} &
  \includegraphics[scale=.5]{Figures/DiagramTable/PD_iso-crop.pdf}  \\
  %%%% TDp
  $$\begin{aligned}
    &TD(P) \\
    &P = D - T
  ...
  \includegraphics[scale=.5]{Figures/DiagramTable/TD_rt-crop.pdf} &
  \includegraphics[scale=.5]{Figures/DiagramTable/TD_iso-crop.pdf}  \\
  \midrule
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \includegraphics[scale=.5]{Figures/DiagramTable/TA_rt-crop.pdf} &
  \includegraphics[scale=.5]{Figures/DiagramTable/TA_iso-crop.pdf}  \\
  %%%% TLa
  $$\begin{aligned}
    &TL(A) \\
    &A = L - T
  ...
  \includegraphics[scale=.5]{Figures/DiagramTable/TL_rt-crop.pdf} &
  \includegraphics[scale=.5]{Figures/DiagramTable/TL_iso-crop.pdf}  \\
  %%%% ALt
  $$\begin{aligned}
    &AL(T) \\
    &T = A - L
  ...
  \includegraphics[scale=.5]{Figures/DiagramTable/AL_rt-crop.pdf} &
  \includegraphics[scale=.5]{Figures/DiagramTable/AL_iso-crop.pdf}  \\
  \midrule
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \includegraphics[scale=.5]{Figures/DiagramTable/LC_rt-crop.pdf} &
  \includegraphics[scale=.5]{Figures/DiagramTable/LC_iso-crop.pdf}  \\
  %%%% CDl
  $$\begin{aligned}
    &CD(L) \\
    &L = D - C
  ...
  \includegraphics[scale=.5]{Figures/DiagramTable/CD_rt-crop.pdf} &
  \includegraphics[scale=.5]{Figures/DiagramTable/CD_iso-crop.pdf}  \\
  %%%% LDc
  $$\begin{aligned}
    &LD(C) \\
    &C = D - L
  ...
  \includegraphics[scale=.5]{Figures/DiagramTable/LD_rt-crop.pdf} &
  \includegraphics[scale=.5]{Figures/DiagramTable/LD_iso-crop.pdf}  \\
  \midrule
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \includegraphics[scale=.5]{Figures/DiagramTable/LP_rt-crop.pdf} &
   \\
  %%%% CT
  CT(-) &
  The CT plane is \emph{non-informative}. No additional measures can be derived knowing just cohort and thanatological age. &
  \includegraphics[scale=.5]{Figures/DiagramTable/CT_rt-crop.pdf} &
   \\
  %%%% AD
  AD(-) &
  The AD plane is \emph{non-informative}. No additional measures can be derived
  knowing just death cohort and age. & \includegraphics[scale=.5]{Figures/DiagramTable/AD_rt-crop.pdf} &
    \\
  \bottomrule
\end{longtable}
...
%dyads. 
While there is no reason not to visualize all possible
...
lifelines depicted are identical those shown in APC Fig.~\ref{fig:APC} and
...
Fig.~\ref{fig:TAL} and appear to be five.} In this view, the user can
...
cohorts, for the length of the lifelines in the figure. However, the
...
study described in complete rigor. Specifically, we reason that health
expectancies for many health conditions cannot be projected, compared between groups, or compared over time without taking into account the time-to-death process and mortality
differences.
...
for time-to-death processes. Finally, one can argue from reason that estimates
of health expecancies for certain health conditions are biased when
mortality has been or will-be changing. We know that mortality has been
changeing, and it is widely assumed that mortality will be changeing, and so we
conclude that comparisons of health expecancies are biased in ways not previously documented.
...
here (the Sullivan curve), one sees an increasing tendency over age.
...
unhealthy life expectancy, or 39\% versus the 4\% observed. 
...
required by this temporal framework and adjusting standard demographic methods
to match the direction of temporal variation in data. There is a wide variety of
prevalence patterns when viewed in this way \citep{riffe2015ttd}, and much
empirical and methodological work is still required to verify
these findings and the consequences for the standard ways of comparing and
projecting healthy life expectancy. Our objective in this application has been
to demonstrate how viewing data under the rigorous conditions required by the
framework we present can lead to new scientific understandings of processes over
the life course.
...
age-standardization will not fully account for such structure
