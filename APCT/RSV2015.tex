...
therefore called uninformative. These dyads, an explanation or example, and the
corresponding graphical representations are summarized in Table~\ref{tab:dyads}.
\pagebreak
\begin{center}
  \small
  ...
  and ternary temporal planes.\protect\footnotemark} 
  \label{tab:dyads} \\
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \midrule
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \multicolumn{4}{c}{\textsc{2-D Combinations of Thanatological Measures}} \\
  \midrule
  %%%% PD
  $$\begin{aligned}
    &PD(T) \\
  ...
  \bottomrule
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \multicolumn{4}{c}{\textsc{2-D Combinations of Lexis and Thanatological
  Measures}}
  \\
  \midrule
  %%%% TL
...
Most of what we think we know about how rates change over age and time comes
...
coordinates, as demographers typically do. Any of the other dyadic
juxtapositions can be considered a relatively novel way of structuring or
