...
the sub-identities and diagrams that pertain to this identity. We provide an application of
this framework to the measurement of late-life morbidity prevalence. We
generalize these relationships to higher order identities derived from an
arbitrary number of events in calendar time. Our examples are based on
classic human demography, but the concepts we present are generally applicable
to event history data setups and to the study of phenomena measured on any scale of
calendar time.
...
different designs and for expanding a given design to its full time
consequences. 
...
the Lexis diagram to N-dimensional space, and finally we present the hexad time-identity.
...
are applicable to the structure and study of any phenomenon based in time. The
implications of this work are therefore of relevance to science in general, and
not only population or social sciences.
...
\vspace{-1em}
\label{fig:srh1905}
\includegraphics[scale=0.32]{Fig7a.pdf}
\end{subfigure}
~
\begin{subfigure}{.46\textwidth}
\centering
...
\vspace{-1em}
\label{fig:srh1910}
\includegraphics[scale=0.32]{Fig7b.pdf}
\end{subfigure}
...
\vspace{-1em}
\label{fig:srh1915}
\includegraphics[scale=0.32]{Fig7c.pdf}
\end{subfigure}
~
\begin{subfigure}{.46\textwidth}
\centering
...
\vspace{-1em}
\label{fig:srh1920}
\includegraphics[scale=0.32]{Fig7d.pdf}
\end{subfigure}
...
\vspace{-1em}
\label{fig:srh1925}
\includegraphics[scale=0.32]{Fig7e.pdf}
\end{subfigure}
~
\begin{subfigure}{.46\textwidth}
\centering
...
\vspace{-1em}
\label{fig:srhlegend}
\includegraphics[scale=0.32]{Fig7Legend.pdf}
\end{subfigure}
\end{figure} 
...
marriage identity and the illness-death model by \citet{brinks2014lexis}. This
general comparison between complex statistical designs serves to illustrate the
...
faces of the tetrahedron is parallel to one of the four temporal planes. The
same relationship between planes and the 3d space would hold for all other
...
the result. The size of the effect varies depending on how fast mortality and
...
old-age morbidity burden could be needlessly pessimistic if it is the case that
the prevalence of pertinent health conditions vary primarily as a function of
time to death. This clearly merits further study in the case of human population
health, and we brazenly speculate that findings of similar import may
easily arise in other areas of investigation.
...
shown in Fig.~7 on the basis of the TAL diagram.
...
Several lines of future research may be augmented by or based on the finds we
present. Most obviously, it is of public health interest to document the range
of late-life morbidity patterns. We do not at this time know how the late life
morbidity patterns referred to here change over time or vary between
populations, for example. This has implications for the use of health
expectancies and related measures in comparative studies of disease burden.
However, the time framework we describe may also be useful more generally to
structure disease processes. The temporal dynamics of classiscal demographic
processes such as childbearing, partner formation and dissolution, migrations,
and temporal interactions between such things may also be \ldots
