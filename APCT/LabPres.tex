...
\begin{figure}[b]
    \centering
       % figure made in R/APClab.R
    \includegraphics[scale=.9]{Figures/LabPres/APC3.pdf}
...
\begin{figure}[b]
    \centering
       % figure made in R/APClab.R
    \includegraphics[scale=.9]{Figures/LabPres/APC4.pdf}
...
\begin{figure}[b]
    \centering
    % figure made in R/APClab.R
    \includegraphics[scale=.9]{Figures/LabPres/APC5.pdf}
...
\begin{figure}
    \centering
  \animategraphics[height=5in]{24}{Figures/LabPres/AnimateLifeLines/frame_}{1}{91}
\end{figure} 
\end{frame} 
