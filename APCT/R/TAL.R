...
points(rep(0,length(lifelines)),lifelines, pch=19,col="blue",xpd=TRUE)
points(lifelines, rep(0,length(lifelines)), pch=13,cex=1.3,col="blue",xpd=TRUE)
text(27,27,"Lifespan",srt=-45,col="blue")
dev.off()
...
text(27+13.5,27*sqrt(3)/2,"Lifespan",srt=-60,col="blue")
dev.off()
