...
compression. A compressed \eg{TPD} diagram has thus far only appeared in
\citet{pancho2015} as an aid in explaining a mathematical proof.
A cross-sectional \eg{ATL} diagram and surfaces have thus far only appeared in
\citet{riffe2015ttd}, selected for the 1915-1919 birth cohort, ergo
belonging to the 3d space.
