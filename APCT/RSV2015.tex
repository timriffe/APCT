...
appeared once in the literature, as a visual aid to a mathematical prood of the
...
*add reference to Riffe, Chung, Spijker, MacInnes (although that TAL was a
cross-section and not a compression) 
The second plane is TAL, a valid coordinate
