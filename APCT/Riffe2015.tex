...
(TTD), but we prefer thanatological age, and to think of the concept of age in
general as marking a position on a lifeline. Chronological age and
...
heterogeneity with respect to time of birth. If reader accepts this premise,
...
surface. This paper will contain no such visualizations, but we may juxtapose
their coordinate bases.
...
\begin{figure}
    ...
    \label{fig:APCeq} 
    \includegraphics[scale=.7]{Figures/LabPres/APC5.pdf}
\end{figure}
