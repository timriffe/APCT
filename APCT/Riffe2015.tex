...
the birth cohort).
The relationship between any two or three of these temporal indices are
intuitive, but the simultaneous relationship between all six indices is likely
confusing.
These six dimensions have to my knowledge never been considered jointly. The only subset thereof that has received serious treatment is the APC
