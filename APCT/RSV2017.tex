...
of which we only present the isotropic mapping.\footnote{To compare,
...
prevalence, each referring to a different quinquennial birth cohort (1905--09,
1910--14, $\dots$). These follow the coordinates of the TAL diagram in Fig.~\ref{fig:TAL}.
