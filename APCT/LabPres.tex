...
\frametitle{CSI Rostock}
\begin{itemize}
    \item<1-> Chrono variation = mortality morbidity tradeoff
    \item<2-> Thano variation = win
    \item<3-> miscategorizing thano variation leads in wrong direction
    \item<4-> assumptions were strong here\ldots
\end{itemize}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%	End of the document					%%
