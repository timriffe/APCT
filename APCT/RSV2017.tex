...
The demographic time framework we propose includes three events (period, birth
cohort, and death cohort), and it therefore leads to a temporal plane graph as
of row 2, column 3 of Table~\ref{tab:timelines}, here redrawn in
Figure~\ref{fig:tet} labelled with the six time indices. \vt{include square
version of the same.}
...
\label{fig:tet}
\begin{subfigure}{.48\textwidth}
\caption{vertices on the unit square}
