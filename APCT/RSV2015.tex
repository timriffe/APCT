...
and period. We show three identities similar to the well-known
age-period-cohort identity, and we then present an identity consisting of all
six time measures. Two versions of the model are described:
a relatively intuitive extension of the right-angled Lexis diagram, and an isotropic extension based on
...
two of its constituent indices, making the third index redundant. Each of these
...
These concepts are analogous to the ideas of birth and death cohorts we use here, though we do not often refer to the
...
relationship between measures. Each of the triad identities can represent some
