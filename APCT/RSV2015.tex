...
of the hexad identity, where birth-cohort TAL cross-sectional planes are placed
in sequence in a perspective drawing.\footnote{The coordinates used to generate
this view are isotropic. However, there are no 60$^\circ$ angles in this figure
due to the use of parallax and and an indirect viewing angle in this rendering
for the sake of increased legibility.} The most recent TAL plane, for year $t$,
is placed in the front, whereas past TAL planes are stacked behind it, highlighted in century intervals.
This view emphasixes how the juxtaposition of thanatological age,
chronological age, and lifespan moves over time. This is the view used in
...
age as well as chronological age (and each of the other indices).
...
thanatological age 0 is the largest because people of any chronological age may
die.
