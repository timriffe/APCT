...
relationships in any event history data, and to the study of human or non-human phenomena measured on any scale of calendar time.
...
set of potential time identities. Of this limitless set of
...
successive time slices in one of the diagrams from Sect.~\ref{sec:dyads2diagrams}, similar to that shown in Fig.~7 on the basis of the TAL diagram.
...
possibly based on even higher dimensional time-spaces. In this case,
...
section~\ref{sec:app} change over time or vary between populations, for example.
...
migrations, employment transitions, and temporal interactions between such
things may also be fully captured and explored under our framework. To do so, we
...
cross-sections of the structured data to locate important patterns in the data.
...
of demographic time both help situate the APC paradigm in a broader framework.
